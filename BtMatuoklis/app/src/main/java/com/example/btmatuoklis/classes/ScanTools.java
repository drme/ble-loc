...
public class ScanTools{
    ...
    public void scanLogic(BluetoothDevice device, int rssi,
                          ArrayList<Beacon> beaconsList, ArrayList<String> displayList){
        byte numDev = 0;
        ...
        if (listSize == 0) {
            ...
            if (numDev > listSize - 1) {
                ...
                displayList.add(numDev, beaconsList.get(numDev).getCurrentInfo());
            }
        }
    }
